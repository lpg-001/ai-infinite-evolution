...
[功能特性](#功能特性) • [快速开始](#快速开始) • [使用指南](#使用指南) • [系统架构](#系统架构) • [贡献指南](#贡献指南)
...
AI无限进化系统是一个创新的技能管理系统，专为Cursor IDE设计，能够让AI助手在每次对话中持续学习和进化。系统通过自动分析对话内容，提取语言模式和思考规则，实现真正的"无限进化"。
...
将项目文件夹在Cursor IDE中打开，系统会自动加载`.cursorrules`文件。
...
A: 目前专为Cursor IDE设计，但核心机制可以适配其他IDE。
